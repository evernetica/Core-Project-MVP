...
public class PinView extends AppCompatEditText {
    ...
    public PinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mPinItemHeight = (int) a.getDimension(R.styleable.PinView_itemHeight, dpToPx(48));
        mPinItemWidth = (int) a.getDimension(R.styleable.PinView_itemWidth, dpToPx(48));
        mPinItemSpacing = a.getDimensionPixelSize(R.styleable.PinView_itemSpacing, dpToPx(5));
        mPinItemRadius = (int) a.getDimension(R.styleable.PinView_itemRadius, 0);
        mLineWidth = (int) a.getDimension(R.styleable.PinView_lineWidth, dpToPx(2));
        ...
        mCursorWidth = a.getDimensionPixelSize(R.styleable.PinView_cursorWidth, dpToPx(2));
